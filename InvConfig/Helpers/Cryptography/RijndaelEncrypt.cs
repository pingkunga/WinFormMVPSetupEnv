...
namespace Helpers.Cryptography
{
	public class Rijndael
	{
        ...
        private static string saltPassword;         //The saltPassword key that was used to encrypt/decrypt the message
		...
		public static byte[] EncryptData(byte[] message, byte[] password, byte[] initialisationVector, BlockSize blockSize, 
		...
		public static string EncryptData(string message, string initialisationVector, BlockSize blockSize, 
		KeySize keySize, EncryptionMode cryptMode, bool returnAsHex)
		{
            ...
            passwordData = encoderUnicode.GetBytes(SaltPassword);
		...
		public static byte[] DecryptData(byte[] message, byte[] password, byte[] initialisationVector, BlockSize blockSize, 
		KeySize keySize, EncryptionMode cryptMode)
		{
			byte[] messageData, keyBlock, vectorBlock, dataBlock;
			int messageLength, encodedLength, nb, nk;
		...
		public static string DecryptData(string message, string initialisationVector, BlockSize blockSize, 
